...
\maketitle
\begin{abstract}
  Basic overview and crap. I will be including some code display and formatting stuff that I will explain later but this will do for now.
\end{abstract}

\section{Introduction}

if you read down to the bottom of this document they actually say that the longest that this document is allowed to be for a NAACL thing is 8 pages. Its pretty crappy that she is requiring that we write the complete maximum number of pages for this thing. -sigh-
