...
public class MLTest {
    ...
    public static final int NUMBER_OF_FEATURES = 20;
    ...
    public static void main(String[] args) throws Exception {
        ...
        extractFeatures(swnfe, hife, trainingTweets, trainingData);
        extractFeatures(swnfe, hife, testingTweets, testingData);
...
//         MLTrain train = new SVMTrain(method, trainingData);
    ...
    public static void printAnalysis(MLRegression mlRegression, ArrayList<TwitterData> tweets,
        ...
        for (int i = 0; i < dataSet.size(); i++) {
            ...
            if (actual == 1 && ideal == 1) tp += 1.0;
            if (actual == 1 && ideal == 0) fp += 1.0;
            if (actual == 0 && ideal == 1) fn += 1.0;
            if (actual == 0 && ideal == 0) tn += 1.0;
        }
...
//        int numberOfNonBullyingTweetsForTraining = numberOfBullyingTweetsForTraining;
    ...
    public static void extractFeatures(SentiWordNetFeatureExtraction swnfe,
            HarvardInquirerFeatureExtraction hife, ArrayList<TwitterData> tweets,
            BasicMLDataSet dataSet) {
